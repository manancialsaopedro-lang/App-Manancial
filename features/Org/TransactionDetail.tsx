...
export const TransactionDetail = () => {
  ...
  useEffect(() => {
    ...
    getTransactionById(id)
      ...
      .catch((error) => console.error('Erro ao buscar transacao:', error))
  ...
  if (!transaction) {
    if (loading) {
      return (
        <div className="max-w-2xl mx-auto space-y-8 animate-in slide-in-from-bottom-4">
          ...
          <Card className="p-8 text-center text-gray-400 font-bold">Carregando transacao...</Card>
        </div>
      );
    }
    ...
    return (
      <div className="max-w-2xl mx-auto space-y-8 animate-in slide-in-from-bottom-4">
        ...
        <Card className="p-8 text-center text-gray-400 font-bold">Transacao nao encontrada.</Card>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 animate-in slide-in-from-bottom-4">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <h2 className="text-3xl font-black text-gray-900 text-center">{fixEncoding(transaction.description)}</h2>
      ...
      <Card className="p-8">
        <h3 className="text-xs font-black uppercase text-gray-400 tracking-widest mb-6">Informacoes Gerais</h3>
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="flex items-center gap-3">
             ...
             <div>
                <p className="text-[10px] font-bold uppercase text-gray-400">Metodo de Pagamento</p>
                <p className="font-bold text-gray-900">{fixEncoding(transaction.paymentMethod) || 'Nao informado'}</p>
             </div>
          </div>
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
             ...
             <div>
                <p className="text-[10px] font-bold uppercase text-gray-400">ID Referencia</p>
